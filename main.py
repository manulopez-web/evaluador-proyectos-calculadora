...
# =====================================================
# INTERPRETACIÓN DEBAJO DE LA GRÁFICA
# =====================================================
...
if punto_critico is not None:
    ...
    st.info(
        f"""
📍 Punto crítico de sensibilidad:

El Valor Presente Neto (VPN) se vuelve cero aproximadamente cuando la tasa de descuento alcanza el **{round(punto_critico, 2)}%**.

A partir de este punto, el proyecto deja de ser rentable bajo las condiciones actuales del flujo de caja.
        """
    )
    ...
    st.success(
        "No se identificó un punto crítico dentro del rango evaluado; el VPN se mantiene positivo."
    )
...
archivo = exportar_excel(df, sens_df)
...
if archivo and os.path.exists(archivo):
    ...
    st.error("El archivo no se pudo generar correctamente")
    # =====================================================
    # CONCLUSIÓN
    # =====================================================
