...
for proyecto in proyectos:
    ...
    # 🔴 PROTECCIÓN ANTI-ERROR (DEBE IR AQUÍ DENTRO)
...
# =====================================================
# DATAFRAME (FUERA DEL FOR, PERO DENTRO DEL BOTÓN)
# =====================================================
...
if "df" in st.session_state and "sens_df" in st.session_state:

    archivo = exportar_excel(
        st.session_state["df"],
        st.session_state["sens_df"]
    )
    ...
    st.info("Primero debes evaluar proyectos antes de exportar")
